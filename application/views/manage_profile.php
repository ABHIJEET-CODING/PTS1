                                ...
                                <form method="post" id="manage_profile_form">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Enrolment No.</label>
                                            <input type="text" class="form-control" name="enrollment_no" placeholder="Enrollment number" value="<?php echo $manage_profile->enrollment_no; ?>" readonly />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="semester" placeholder="Enter semester" value="<?php echo $manage_profile->semester; ?>" readonly />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="nuumber" class="form-control" name="contact_no" placeholder="Contact no" value="<?php echo $manage_profile->contact_no; ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Birth Date</label>
                                            <input type="nuumber" class="form-control" name="date of birth" placeholder="date of birth" value="<?php echo $manage_profile->date_of_birth; ?>" readonly/>
                                        </div>
                                         <div class="form-group">
                                            <label for="exampleInputEmail1">Passing Year</label>
                                            <input type="nuumber" class="form-control" name="passing year" placeholder="passing year" value="<?php echo $manage_profile->passing_year; ?>" readonly/>
                                        </div>
                                        <!-- <div class="form-group">
